...
<form method="POST" name="login"  ACTION="loginAdmin.php">
	...
	<tr>
		...
		<td>
			...
			<table width="350" border="0" class="outerBorder">
				...
				<tr>
					<td width="45%" height="21" valign="middle" align="right">Customer Service Number</td>
					<td width="5%">&nbsp;</td>
		...
		<td>
			<table cellpadding=20 width="100%">
				<tr>
					...
					<td align="center"><img border="0" src="images/custsup.gif"></td>
				</tr>
			</table>
		</td>
	</tr>	

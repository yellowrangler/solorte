...
<table width="100%" class="SmTxt">
	...
	<tr>
		...
		<td align=left colspan=5><input size=40 maxlength=255 type="text" name="payorname" value="<?php print $result_array[Name]; ?>"> </td>
	</tr>
	<tr>
		<td align=right>Payor Type:</td>
		<td align=left>
			<select name="payortype"> 
				<option class="smallTxtGry" value="<?php print  $result_array[TypeID]; ?>"><?php print  $result_array[PayorDesc]; ?> 
				<?php print $DisplayPayorTypeList; ?>
			</select>
		</td>
	</tr>	
	<tr>
...
<input type="hidden" name="payorid" value="<?php print $result_array[payorID]; ?>">	
<br><center>
<table>
	<tr>

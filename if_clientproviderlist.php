...
// Set special globals.
//----------------------------------------------------------------------------------------------------------
$module = 'if_clientproviderlist.php';
...
{
	$sql = "SELECT  Prefix, FirstName, MI, LastName, Suffix, ProviderTBL.ID as ProviderID
		from ProviderTBL 
...
if ($countRows < 0)
{
	$errmsg = " Error less then 0 rows returned in select on ProviderTBL. count = '$countRows'";
	$location = "";
	$severity = 1;	
	$shortmsg = "System DB error.  If this persists, Please call Customer Support.";
	LogErr($shortmsg, $errmsg, $location, $module, $severity);
		...
		$DisplayList .= " 
			<tr> 
				<td valign=left class=\"tblDetailsmTextOff\" id=\"td".$i."\" align=left height=20>
					<a id=\"a".$i."\" href=\"if_clientproviderinfo.php?providerid=".$result_array[ProviderID]."\" target=\"clientprovidermainFrame\" target=\"ClientProviderListFrame\" class=\"tblDetailsmTextOff\">".$DisplayName."</a>
				</td> 
			</tr>
			";
		...
		$DisplayList .= " 
			<tr> 
				<td valign=left class=\"tblDetailsmTextOn\" id=\"td".$i."\" align=left height=20>
					<a id=\"a".$i."\" href=\"if_clientproviderinfo.php?providerid=".$result_array[ProviderID]."\" target=\"clientprovidermainFrame\" class=\"tblDetailsmTextOn\">".$DisplayName."</a>
				</td> 
			</tr>
			";
...
<head>
<title>HealthYourSelf Manage Client Provider Information</title>

...
$sql = "SELECT * from ClientSpecialInstructionsTBL 
		where (ClientSpecialInstructionsTBL.MEDPAL = '$Medpal') 
		order by OrderID";
...
if ($countRows > 0)
{
	...
	{
		// lets build display block for SpecialInstructions
		$DisplayBlock .= "\t<tr>\n";
		
		$DisplayBlock .= "\t\t<td width=\"10%\" height=20 align=right><input size=2 maxlength=2 type=\"text\" name=\"profsiorder".$i."\" value=\"".$result_array[OrderID]."\">: </td>\n";
		$DisplayBlock .= "\t\t<td align=left><input size=70 maxlength=255 type=\"text\" name=\"profsi".$i."\" value=\"". $result_array[SpecialInstructions]."\"></td>\n";
...
while ($i < 13)
{
	// lets build empty display block for  SpecialInstructions
	$DisplayBlock .= "\t<tr>\n";
	
	$DisplayBlock .= "\t\t<td width=\"10%\" height=20 align=right><input size=2 maxlength=2 type=\"text\" name=\"profsiorder".$i."\" value=\"".$i."\">: </td>\n";
	$DisplayBlock .= "\t\t<td align=left><input size=70 maxlength=255 type=\"text\" name=\"profsi".$i."\" value=\"None\"></td>\n";
...
<head>
<title>HealthYourSelf Customer Special Instructions Info</title>
...
<table width="100%" class="outerBorderMessageTitleBlue">
	<tr>
		 <td height=20 align="center">Special Instructions</td>
	</tr>	
</table>

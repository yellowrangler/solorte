			...
			$DisplayList .= " 
				<tr> 
					<td valign=left class=\"tblDetailsmTextOff\" id=\"td".$i."\" align=left height=20>
						<a id=\"a".$i."\" href=\"providerhost.php?hostid=".$result_array[ID]."&Action=add&providerid=".$_GET[providerid]."\" target=\"mainFrame\" class=\"tblDetailsmTextOff\">".$DisplayName."</a>
					</td> 
				</tr>
				";
			...
			$DisplayList .= " 
				<tr> 
					<td valign=left class=\"tblDetailsmTextOn\" id=\"td".$i."\" align=left height=20>
						<a id=\"a".$i."\" href=\"providerhost.php?hostid=".$result_array[ID]."&Action=add&providerid=".$_GET[providerid]."\"  target=\"mainFrame\" class=\"tblDetailsmTextOn\">".$DisplayName."</a>
					</td> 
				</tr>
				";
			$FlipFlag = 1;		

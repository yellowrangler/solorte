...
$module = 'if_UAmedprofBehavioral.php';
...
$sql = "SELECT * from ClientBehavioralTBL 
		where (ClientBehavioralTBL.MEDPAL = '$Medpal') 
		order by OrderID";
...
if ($countRows > 0)
{
	...
	{
		// lets build display block for cronic Behaviors
		$DisplayBlock .= "\t<tr>\n";
		
		$DisplayBlock .= "\t\t<td width=\"10%\" height=20 align=right><input size=2 maxlength=2 type=\"text\" name=\"profbehaveorder".$i."\" value=\"".$result_array[OrderID]."\">: </td>\n";
		$DisplayBlock .= "\t\t<td align=left><input size=70 maxlength=255 type=\"text\" name=\"profbehave".$i."\" value=\"". $result_array[Behavior]."\"></td>\n";
...
while ($i < 13)
{
	// lets build empty display block for cronic Behaviors
	$DisplayBlock .= "\t<tr>\n";
	
	$DisplayBlock .= "\t\t<td width=\"10%\" height=20 align=right><input size=2 maxlength=2 type=\"text\" name=\"profbehaveorder".$i."\" value=\"".$i."\">: </td>\n";
	$DisplayBlock .= "\t\t<td align=left><input size=70 maxlength=255 type=\"text\" name=\"profbehave".$i."\" value=\"None\"></td>\n";
...
<head>
<title>HealthYourSelf Customer Behavioral Info</title>
...
<form  action="UAmedprofBehavioral.php" method=post>
<table width="100%" class="outerBorderMessageTitleBlue">
	<tr>
		 <td height=20 align="center">Behavioral Profile</td>
	</tr>	
</table>

...
<form name="search" method="post" ACTION="if_hostlist.php" target="HostListFrame">
...
<IFRAME name="HostListFrame" src="if_hostlist.php"  class="innerleftHostList" scrolling="yes"></IFRAME>
</div>

<div class="daButtons">
<center>
<form name="refresh" method="post" ACTION="if_hostlist.php" target="HostListFrame">
<table>
	<tr>
...
<form name="select" method="post" ACTION="if_hostinfo.php" target="mainFrame">
<table>
	<tr>
		<td align=center><input type=submit size=150 NAME="SUBMIT" VALUE="Add Host"></td> 
	</tr>
</table>
<input type='hidden' name='dummy'  value=''>
</form>
...
<div align="center" >
<IFRAME name="mainFrame" src="if_hostinfo.php"  class="rightcontent" scrolling="no" frameborder="0"></IFRAME>
</div>
</div>

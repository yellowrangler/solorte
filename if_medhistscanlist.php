...
// Used to turn colors on and off 
	...
	while ($result_arr = mysql_fetch_assoc($sql_result))
	{
		...
		if ($FlipFlag == 1)
		{
			$DisplayBlock .= "
				<tr>
					<td height=".$lineHeight." width=\"25%\" align=center class=\"tblDetailsmTextOff\">".$result_arr[ScanType]."</td>
		...
		else
		{
			$DisplayBlock .= "
				<tr>	
					<td height=".$lineHeight." width=\"25%\" align=center class=\"tblDetailsmTextOn\">".$result_arr[ScanType]."</td>

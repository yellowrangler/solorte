...
$sql = "SELECT ClientPrescriptionTBL.ID as CP_ID, MEDPAL, PrescrNbr, CalendarID, PharmacyID, Medication, 
				...
				left join PharmacyTBL on ClientPrescriptionTBL.PharmacyID = PharmacyTBL.ID
...
if (isset($_GET[order]))
{
	...
	switch ($_GET[order])
	{
		...
		case 'pharmacy':
			$sql .= " ORDER BY PharmacyName ".$_SESSION[MHParmacy];
			if ($_SESSION[MHParmacy] == "ASC")
				$_SESSION[MHParmacy] = "DESC";
			else
				$_SESSION[MHParmacy] = "ASC";
			break;	
...
{	
	...
	while ($result_arr = mysql_fetch_assoc($sql_result))
	{
		...
		$PrescriptionID = "Not Supplied";
		
		$RenewDate = CovertMySQLDate($result_arr["EndDate"], 1, 1);
		$AppTime = CovertMySQLTime($result_arr["EndTime"], 1, 2);
		...
		$PharmacyName = $result_arr[PharmacyName];
			...
			$DisplayBlock .= "
				<tr>
					<td width=\"5%\" align=center height=17 class=\"tblDetailsmTextOff\">
						<a href=\"if_prescdetail.php?prescid=".$PrescID."\" target=\"detailFrame\">
					...
					<td width=\"20%\" align=left height=17 class=\"tblDetailsmTextOff\">".$Medication."</td>
					<td width=\"20%\" align=left height=17 class=\"tblDetailsmTextOff\">".substr($Provider, 0, 16)."</td>
					<td width=\"15%\" align=left height=17 class=\"tblDetailsmTextOff\">".$PrescrNbr."</td>
					<td width=\"25%\" align=left height=17 class=\"tblDetailsmTextOff\">".$PharmacyName."</td>
				</tr>
			";
			...
			$DisplayBlock .= "
				<tr>
					<td width=\"5%\" align=center height=17 class=\"tblDetailsmTextOn\">
						<a href=\"if_prescdetail.php?msgTxt=Welcome to Update Prescriptions!&prescid=".$PrescID."\" target=\"detailFrame\">
					...
					<td width=\"20%\" align=left height=17 class=\"tblDetailsmTextOn\">".$Medication."</td>
					<td width=\"20%\" align=left height=17 class=\"tblDetailsmTextOn\">".substr($Provider, 0, 16)."</td>
					<td width=\"15%\" align=left height=17 class=\"tblDetailsmTextOn\">".$PrescrNbr."</td>
					<td width=\"25%\" align=left height=17 class=\"tblDetailsmTextOn\">".$PharmacyName."</td>
				</tr>
				";
...
else
{
	$DisplayBlock .= "
		<tr>
			...
			<td width=\"20%\" align=left height=17 class=\"tblDetailsmTextOff\">No Prescription</td>

	...
	if ($FlipFlag == 1)
	{
		$DisplayList .= " 
			<tr> 
				...
				<td width=\"5%\" align=center height=20 class=\"tblDetailsmTextOn\">
						<a href=\"if_proxyaccess.php?proxytype=".$result_auth_array[ProxyType]."&proxyuserid=".$result_auth_array[ProxyUserID]."\" target=\"mainFrame\">

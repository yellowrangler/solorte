		...
		$DisplayList .= " 
			<tr> 
				<td valign=left class=\"tblDetailsmTextOff\" id=\"td".$i."\" align=left height=20>
					<a id=\"a".$i."\" href=\"if_clienthostinfo.php?hostid=".$result_array[HostID]."\" target=\"clienthostmainFrame\" target=\"ClientHostListFrame\" class=\"tblDetailsmTextOff\">".$result_array[Name]."</a>
				</td> 
			</tr>
			";
		...
		$DisplayList .= " 
			<tr> 
				<td valign=left class=\"tblDetailsmTextOn\" id=\"td".$i."\" align=left height=20>
					<a id=\"a".$i."\" href=\"if_clienthostinfo.php?hostid=".$result_array[HostID]."\" target=\"clienthostmainFrame\" class=\"tblDetailsmTextOn\">".$result_array[Name]."</a>
				</td> 
			</tr>
			";
...
<head>
<title>HealthYourSelf Manage Client Host Information</title>

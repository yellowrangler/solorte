...
// Gets come from if_proxyaccesslist Posts come from if_proxyaccess
//----------------------------------------------------------------------------------------------------------
if (isset($_GET[medpal]) && ($_GET[medpal] != "") )
{
	//-------------------------------------------------------------------------------------------------
	// Assume we are a GET for all data and that we have been called by if_proxyaccesslist
	//-------------------------------------------------------------------------------------------------
	$medpal = $_GET[medpal];
...
else
{
	...
	{	
		...
		$location = "Location: if_proxyaccess.php";
		$severity = 1;
...
// Move to next page
//--------------------------------------------------------------------------------------------------
header("Location: if_proxyaccess.php?proxyuserid=$ProxyUserID&proxytype=$ProxyType&medpal=$medpal&msgTxt=$DisplayMsg");

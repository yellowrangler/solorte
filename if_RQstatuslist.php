...
{	
	...
	while ($result_arr = mysql_fetch_assoc($sql_result))
	{
		...
		if ($FlipFlag == 1)
		{
			...
			$DisplayBlock .= "<a href=\"if_RQstatusdetail.php?requestid=".$result_arr[crID]."\" target=\"detailFrame\"><img id=\"moredetail\" height=20 width=20 border=\"0\" src=\"images/binoculars.gif\"></a></td>\n";
		...
		else
		{
			...
			$DisplayBlock .= "<a href=\"if_RQstatusdetail.php?requestid=".$result_arr[crID]."\" target=\"detailFrame\"><img id=\"moredetail\" height=20 width=20 border=\"0\" src=\"images/binocularsOn.gif\"></a></td>\n";

...
<table width="100%">	
	<tr>
		<td align="left" width="80%"><b>Here you can update both your personel medical and account information.  Please select from one of the items on the left to start the
		update process.</b></td>  
	</tr>
	<tr>
